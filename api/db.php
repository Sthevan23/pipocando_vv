  ...
  try {
    ...
    if ($productsExists) {
      ...
      aurora_ensure_column(
        ...
        'products',
        'stock',
        "INT DEFAULT NULL COMMENT 'NULL = sem controle de estoque'"
      );
    ...
    if ($settingsExists) {
      aurora_ensure_column(
        ...
        'settings',
        'delivery_fee',
        "DECIMAL(10,2) NOT NULL DEFAULT 5.00 COMMENT 'Frete Vila Velha / Cariacica'"
      );
      aurora_ensure_column(
        $pdo,
        'settings',
        'delivery_note',
        "VARCHAR(255) NULL DEFAULT 'Vila Velha R$ 5 · Vitória R$ 10 · Cariacica R$ 5' COMMENT 'Texto extra do frete'"
      );
